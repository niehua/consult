...
public class LoginUtil {
	 //获取code的请求地址
    private static String Get_Code = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=%s&redirect_uri=%s&response_type=code&scope=%s&state=STATE#wechat_redirect";
    //替换字符串
    ...
    //拉取用户信息的请求地址
    private static String User_Info = "https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s&lang=zh_CN";
    //替换字符串
